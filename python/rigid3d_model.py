...
class Rigid3DSystem:
    ...
    def construct(problem_name):
        ...
        #
        system.dim = pos.size
        system.pos_dim = 3  # Rigid3D systems work in 3D space
        ...
        # Add methods for C++ bridge compatibility
        def get_full_position(self, system_def, q):
            # Combine fixed and movable bodies, return as (n_bodies, 4, 3)
            full_pos = jnp.concatenate((system_def['fixed_pos'], q))
            return full_pos.reshape(-1, 4, 3)
